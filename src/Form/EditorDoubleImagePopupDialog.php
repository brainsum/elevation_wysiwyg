...
namespace Drupal\elevation_wysiwyg\Form;
...
class EditorDoubleImagePopupDialog extends EditorImageDialog {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, Editor $editor = NULL) {
    ...
    $form['attributes_left']['src'] = array(
      '#title' => $this->t('URL'),
      '#type' => 'textfield',
    ...
    $form['attributes_left']['alt'] = array(
    ...
    $form['attributes_right']['src'] = array(
      '#title' => $this->t('URL'),
      '#type' => 'textfield',
      '#default_value' => isset($image_element['src']) ? $image_element['src'] : '',
      '#maxlength' => 2048,
    ...
    $form['attributes_right']['alt'] = array(
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $fid_left = $form_state->getValue(array('fid_left', 0));
    $fid_right = $form_state->getValue(array('fid_right', 0));
    if (!empty($fid_left) && !empty($fid_right)) {
      ...
      $image_render = "<div>
        <div class=\"sbs-full-image\">
          <img data-align='left' alt='" . $form_state->getValue(array('attributes_left', 'alt')) . "' data-entity-type=\"file\" data-entity-uuid='" . $file_left->uuid() . "' src='" . $absolute_path_left . "' width='315' />
          <img data-align='right' alt='" . $form_state->getValue(array('attributes_right', 'alt')) . "' data-entity-type=\"file\" data-entity-uuid='" . $file_right->uuid() . "' src='" . $absolute_path_right . "' width='315' />
        </div></div>";
