...
(function (CKEDITOR) {
  ...
  CKEDITOR.plugins.add('elevation_video', {
    ...
    addCommand: function (editor) {
      ...
      editor.addCommand('video_embed', {
        exec: function (editor, data) {
          ...
          Drupal.ckeditor.openDialog(editor, Drupal.url('elevation_wysiwyg/dialog/single_video/' + editor.config.drupal.format), existingValues, modalSaveWrapper, {
